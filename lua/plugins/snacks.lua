...
return {
  ...
  keys = {
    ...
    { "<A-\\>",     "<Esc><Cmd>lua Snacks.terminal.toggle(nil, { win = { position = 'right' } })<CR>", mode = "i", desc = "Terminal toggle (vertical)" },
    { "<F5>",       function() Snacks.terminal.toggle(nil, { win = { position = "right" } }) end, mode = { "n", "t" }, desc = "Terminal toggle (vertical)" },
    { "<F5>",       "<Esc><Cmd>lua Snacks.terminal.toggle(nil, { win = { position = 'right' } })<CR>", mode = "i", desc = "Terminal toggle (vertical)" },
    { "<A-d>",      function() Snacks.terminal.toggle(nil, { win = { position = "float" } }) end, mode = { "n", "t" }, desc = "Terminal toggle (float)" },
    { "<A-d>",      "<Esc><Cmd>lua Snacks.terminal.toggle(nil, { win = { position = 'float' } })<CR>", mode = "i", desc = "Terminal toggle (float)" },
    ...
    -- legacy: command panel / find words
    { "<C-p>",      function() Snacks.picker.keymaps() end,                desc = "Keymaps panel" },
    { "<leader>fp", function() Snacks.picker.grep() end,                   desc = "Find patterns" },
    { "<leader>fs", function() Snacks.picker.grep_word() end,              mode = "v", desc = "Grep word under cursor" },
  },
}
